<template>
  <div class="panel list-item panel-default">
    ...
    <div :id="'poll-collapse-' + pollAct.id" class="panel-collapse collapse" role="tabpanel" :aria-labelledby="'poll-heading-' + pollAct.id">
  ...
  export default {
    ...
    computed: {
      ...
      pollUrl() {
        ...
        return window.location.origin + '/poll/' + this.pollAct.id
