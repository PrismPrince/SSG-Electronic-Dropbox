...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9">
            ...
            <p><a href="https://www.facebook.com/CTUMCSSG">Tomorrow's Council</a> is the official Facebook page of the Supreme Student Government of Cebu Technological University - Main Campus.</p>
            <p>The highest governing student body in <a href="https://http://www.ctu.edu.ph">Cebu Technological University - Main Campus</a>.</p>
          </div> {{-- .col-sm-9 --}}
        </div> {{-- .row --}}

        <div class="row">
          <div class="col-sm-3 hidden-xs">
            <a href="http://www.ctu.edu.ph/transparency-seal/" style="display: block;padding: 0 20px;">
          ...
          <div class="col-sm-3">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <a href="http://www.ctu.edu.ph/transparency-seal/">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4">
            ...
            <address>
              <a href="https://www.ctu.edu.ph/departments/">Campus Directory</a>
            </address>
          </div> {{-- .col-sm-4 --}}
          ...
          <div class="col-sm-4">
            ...
            <ul class="list-unstyled">
              <li><a href="https://www.ctu.edu.ph/list-of-vacant-positions/">List of Vacant Positions</a></li>
              <li><a href="http://www.ctu.edu.ph/#">Online Job Application</a></li>
              <li><a href="http://www.ctu.edu.ph/#">CTU Hymn</a></li>
              <li><a href="http://www.ctu.edu.ph/#">CTU Main Alumni</a></li>
              <li><a href="http://www.ctu.edu.ph/#">Graduate School Online</a></li>
              <li><a href="http://www.ctu.edu.ph/feedback/">Feedback</a></li>
              <li><a href="http://www.ctu.edu.ph/studentwebapp/">CTU WebApp</a></li>
              <li><a href="http://www.ctu.edu.ph/online-public-access-catalog-opac/">Library OPAC</a></li>
              <li><a href="http://www.ctu.edu.ph/library-proquest/">Library ProQuest</a></li>
              <li><hr></li>
              <li><a href="http://www.ctu.edu.ph/#">Students</a></li>
              <li><a href="http://www.ctu.edu.ph/#">Faculty</a></li>
              <li><a href="http://www.ctu.edu.ph/#">Parents</a></li>
              <li><a href="http://www.ctu.edu.ph/#">Visitors</a></li>
              <li><a href="http://www.ctu.edu.ph/#">Staff</a></li>
            </ul> {{-- .list-unstyled --}}
          </div> {{-- .col-sm-4 --}}
          ...
          <div class="col-sm-4 government-links">
            ...
            <div class="row">
              <div class="col-xs-12">
                <a href="http://www.gov.ph/" title="OFFICIAL GAZETTE OF THE REPUBLIC OF THE PHILIPPINES">
            ...
            <div class="row">
              <div class="col-xs-4">
                <a href="http://www.coa.gov.ph/" title="COMMISSION ON AUDIT(COA)">
                  <img src="{{ asset('/images/government/coa.png') }}" alt="COMMISSION ON AUDIT(COA)">
                </a>
              </div> {{-- .col-xs-4 --}}
              <div class="col-xs-4">
                <a href="http://www.dost.gov.ph/" title="Department of Science and Technology (DOST)">
                  <img src="{{ asset('images/government/dost.png') }}" alt="Department of Science and Technology (DOST)">
                </a>
              </div> {{-- .col-xs-4 --}}
              <div class="col-xs-4">
                <a href="http://www.ched.gov.ph/" title="COMMISSION ON HIGHER EDUCATION (CHED)">
            ...
            <div class="row">
              <div class="col-xs-4">
                <a href="http://www.philgeps.gov.ph/" title="PHILIPPINE GOVERNMENT ELECTRONIC PROCUREMENT SYSTEM (PHILGEPS)">
                  <img src="{{ asset('/images/government/philgeps.png') }}" alt="PHILIPPINE GOVERNMENT ELECTRONIC PROCUREMENT SYSTEM (PHILGEPS)">
                </a>
              </div> {{-- .col-xs-4 --}}
              <div class="col-xs-4">
                <a href="http://www.doe.gov.ph/" title="DEPARTMENT OF ENERGY (DOE)">
                  <img src="{{ asset('/images/government/doe.png') }}" alt="DEPARTMENT OF ENERGY (DOE)">
                </a>
              </div> {{-- .col-xs-4 --}}
              <div class="col-xs-4">
                <a href="http://www.doh.gov.ph/" title="DEPARTMENT OF HEALTH (DOH)">
            ...
            <div class="row">
              <div class="col-xs-4">
                <a href="http://itsmorefuninthephilippines.com/" title="DEPARTMENT OF TOURISM (DOT)">
                  <img src="{{ asset('/images/government/dot.png') }}" alt="DEPARTMENT OF TOURISM (DOT)">
                </a>
              </div> {{-- .col-xs-4 --}}
              <div class="col-xs-4">
                <a href="http://www.dole.gov.ph/" title="DEPARTMENT OF LABOR AND EMPLOYMENT (DOLE)">
                  <img src="{{ asset('/images/government/dole.png') }}" alt="DEPARTMENT OF LABOR AND EMPLOYMENT (DOLE)">
                </a>
              </div> {{-- .col-xs-4 --}}
              <div class="col-xs-4">
                <a href="http://www.dof.gov.ph/" title="DEPARTMENT OF FINANCE (DOF)">
    ...
    <footer class="text-center">
      <div class="container">
        <a href="http://www.ctu.edu.ph/terms-of-use/">Terms of Use</a> | <a href="http://www.ctu.edu.ph/privacy-statement/">Privacy Statement</a>
