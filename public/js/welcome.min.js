 ...
 * ===================================================================================================
 */
window.$=window.jQuery=n(1),n(0),$("body").scrollspy({target:"#app-navbar-collapse",offset:50}),$("#app-navbar-collapse a").on("click",function(t){if(""!==this.hash){t.preventDefault();var e=this.hash;$("html, body").animate({scrollTop:$(e).offset().top},800)}})}]);